...
var scriptsJsPath = '../src/main/resources/static'; //folder for final scripts.js/scripts.min.js files

// css file paths
var cssFolder = '../src/main/resources/static'; // folder for final style.css/style-custom-prop-fallbac.css files
...
gulp.task('watch', gulp.series(['browserSync', 'sass', 'scripts'], function () {
  gulp.watch('../src/main/resources/templates/*.html', gulp.series(reload));
